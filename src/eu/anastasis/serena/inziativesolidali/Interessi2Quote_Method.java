...
/**
 * Si traduce in 2 operazioni:
 * - acquisto di quote
 * - prelievo del valore corrispondente
 * @author andrea
 *
 */
public class Interessi2Quote_Method extends DetailEditMethod {

	public Interessi2Quote_Method(DefaultModule defaultModule,
			String[] defaultParameters) {
		super(defaultModule, defaultParameters);
		// TODO Auto-generated constructor stub
	}
	
	public static final String METHOD_NAME = "interessi2quote";
	...
	throws IndexQueryException
	{
		...
		String resto = request.getParameter("EXTRA_importo_prestito"); // questa parte "resta " nel libretto
		int prelievo = -(new Integer(numero_quote).intValue() * new Integer(valore_quota).intValue());
		...
		movimentoInserito.element(Movimenti_Libretti.SLOT_IMPORTO).setText(new Integer(prelievo).toString());
		Element causale = movimentoInserito.addElement(Movimenti_Libretti.SLOT_CAUSALE_LIBRETTO);
		causale.setText(Movimenti_Libretti.CAUSALE_LIBRETTO__PRELIEVO);
